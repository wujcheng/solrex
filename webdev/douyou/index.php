...
<p>这个小项目完全是出于兴趣写成的，因此很简陋且维持在可用的水平上，我也没有更优化它的想法。在我服务器能承受的情况下我会尽量维持它，但本人不对服务的有效性和可用性做出任何承诺。</p>
...
function show() {
  ...
  userinput.value = "豆瓣用户名，非 email，英文或数字";
}
</script>
<p>输入豆瓣帐号：<input name="username" id="username" tabindex="1" value="豆瓣用户名，非 email，英文或数字" size="40" type="text">
<input value="提交" tabindex="2" type="button" onclick="show()"></p>
<p id="user_dc_img"></p>
<p>您可以把下面这段代码嵌入到您的博客或者主页中来显示豆瓣好友统计：</p>
<p><blockquote id="user_dc_code">请先提交您的豆瓣帐号</blockquote></p>
<h3>联系我</h3>
<p>请到<a href="http://solrex.cn">我的主页</a>寻找我的联系方式。</p>
<h3>我的其它链接</h3>
<ul>
