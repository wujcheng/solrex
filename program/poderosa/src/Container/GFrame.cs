...
namespace Poderosa.Forms
{
	...
	internal class GFrame : Form {
		...
		private MultiPaneControl _multiPaneControl;
		...
		private void InitContextMenu() {
			//コンテキストメニューは、コピー・ペーストおよびコンソールメニュー内容から成る
		...
		/*
		public MenuItem MenuLineFeedRule {
			get {
				return _menuLineFeedRule;
			}
		}
		*/
		...
		/*
		 * コンソールメニューのUI調整は、メインメニュー内部をいじる場合とポップアップメニューをいじる場合がある。
		 * 両者のコードを統一するためにこのメソッドが存在する。ポップアップメニューはメインメニューからCloneMenuされて
		 * 作られたものなので、子メニューを直接いじるわけにはいかない。
		 */ 
