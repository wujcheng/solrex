...
* $Id: SSHShortcutLoginDialog.cs,v 1.2 2005/04/20 09:08:28 okajima Exp $
*/
using System;
...
namespace Poderosa.PortForwarding
{
	...
	{
		private const int WM_ASYNCCONNECT = Win32.WM_USER+1;
		...
		private void InitUI() {
			...
			if(_profile.SSHPort!=22) _methodBox.Text += String.Format(Env.Strings.GetString("Caption.SSHShortcutLoginDialog.NotRegularPort"), _profile.SSHPort);
		...
		private void OnOK(object sender, System.EventArgs e) {
			...
			if(ValidateContent()==null) return;  //パラメータに誤りがあれば即脱出
		...
		public void ConnectionFailed(string message) {
			...
			Win32.SendMessage(_savedHWND, WM_ASYNCCONNECT, IntPtr.Zero, IntPtr.Zero);
		}
