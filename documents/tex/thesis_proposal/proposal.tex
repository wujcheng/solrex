...
WSN~安全定位技术是一个比较新的研究课题，对其系统的研究起源于~2003~年左右。目前来讲，~WSN~的安全定位技术主要分为用密码学手段保护定位信息、检测和屏蔽攻击节点或异常消息、鲁棒的位置算法和位置验证技术等几大类。下面我们对这几大类技术进行一些简单的说明和分析。

\begin{itemize}

\item 密码学手段(Security through Cryptography)。\cite{Lazos2006}\cite{Lazos2005}\cite{Lazos2005a}\cite{Capkun2005}
...
\item 位置验证技术(Location Verification)。\cite{Du2006}\cite{Fang2005}\cite{Capkun2008}\cite{Capkun2006a}\cite{Sastry2003}
