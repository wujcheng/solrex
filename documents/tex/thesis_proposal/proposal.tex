...
\item 位置验证技术(Location Verification)。位置验证也是安全定位研究中非常重要的一个方面，它将视角从直接解决安全定位问题转向验证定位结果是否正确。\cite{Sastry2003}\cite{Fang2005}\cite{Lazos2005a}\cite{Du2006}\cite{Capkun2006a}\cite{Capkun2008}
