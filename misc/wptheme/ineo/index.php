...
;echo '
';if ($options['notice'] &&$options['notice_content']) : ;echo '	<div id="notice">
		<div class="content">
			';echo($options['notice_content']);;echo '		</div>
	</div>
';elseif(function_exists (news_announcement)) : ;echo '	<div id="notice">
		<div class="content">
			';news_announcement();;echo '		</div>
	</div>
';endif;;echo '
...
';if (have_posts()) : $i=0;while (have_posts()) : $i++;the_post();update_post_caches($posts);;echo '	<div class="post" id="post-';the_ID();;echo '">
		...
		';if ($i>3){;echo '			<div class="content blank_content clearfix"></div>
