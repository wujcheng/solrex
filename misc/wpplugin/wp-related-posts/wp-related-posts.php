...
function wp_get_related_posts($exclude, $limit, $wp_rp_title, $wp_no_rp, $wp_no_rp_text, $show_date, $show_comments_count, $show_excerpt, $excerpt_length) {
  ...
  if (!$related_posts){
    ...
    if($wp_no_rp == "text"){
      if(!$wp_no_rp_text) $wp_no_rp_text= __("Not Related Posts",'wp_related_posts');
...
function wp_related_posts_for_feed($content=""){
  ...
  $show_date = $wp_rp["wp_rp_date"];
  $show_comments_count = $wp_rp["wp_rp_comments"];
  $show_excerpt = $wp_rp["wp_rp_excerpt_rss"];
  $excerpt_length = $wp_rp["wp_rp_excerpt_rss_length"];
...
function wp_related_posts_options_subpanel() {
  if($_POST["wp_rp_Submit"]){
    ...
    $wp_rp = array (
      ...
      'wp_rp_excerpt_rss'  => $_POST['wp_rp_excerpt_rss_option'],
      'wp_rp_excerpt_rss_length'  => $_POST['wp_rp_excerpt_rss_length_option']
    );
...
?>
    <div class="wrap">
        ...
        <table class="form-table">
          ...
          <tr>
            <th><?php _e("When not found related posts, show:",'wp_related_posts'); ?></th>
            <td>
          ...
          <tr>
            <th><?php _e("Not related posts' title:",'wp_related_posts'); ?></th>
            <td>
              <input type="text" name="wp_no_rp_text_option" value="<?php echo $wp_rp["wp_no_rp_text"]; ?>" />
            </td>
          </tr>
          <tr>
            <th><?php _e("# of posts:",'wp_related_posts');?></th>
            <td>
          ...
          <tr>
            <th><?php _e("Other options:",'wp_related_posts');?></th>
            <td>
              <label>
              <?php
              ...
              _e("Auto insert related posts",'wp_related_posts');
              ?>
              </label>
              <br />
              <label>
              ...
              _e("Add related posts to FEED",'wp_related_posts');
              ?>
              </label>
              <br />
              <label>
              ...
              _e("Show comments count",'wp_related_posts');
              ?>
              </label>
              <br />
              <label>
              ...
              _e("Show post date",'wp_related_posts');
              ?>
              </label>
              <br />
              <!-- 2008/12/13 modified by Solrex START -->
              <label>
              <?php
              ...
              _e("Display excerpt.",'wp_related_posts');
              ?>
              </label>
              <label>
              <?php _e(" Length (# of char):",'wp_related_posts');?>
              <?php echo '<input name="wp_rp_excerpt_length_option" type="text" value="' . $wp_rp["wp_rp_excerpt_length"] . '">'; ?>
              </label>
              <br />
              <?php
              if ( $wp_rp["wp_rp_excerpt_rss"] == 'yes' ) {
                echo '<input name="wp_rp_excerpt_rss_option" type="checkbox" value="yes" checked>';
              } else {
                echo '<input name="wp_rp_excerpt_rss_option" type="checkbox" value="yes">';
              }
              _e("Display excerpt in FEED.",'wp_related_posts');
              ?>
              <label>
              <?php _e(" Length (# of char):",'wp_related_posts');?>
              <?php echo '<input name="wp_rp_excerpt_rss_length_option" type="text" value="' . $wp_rp["wp_rp_excerpt_rss_length"] . '">'; ?>
              </label>
              <br />
              <!-- 2009/12/13 modified by Solrex END -->
            </td>
          </tr>
        </table>
